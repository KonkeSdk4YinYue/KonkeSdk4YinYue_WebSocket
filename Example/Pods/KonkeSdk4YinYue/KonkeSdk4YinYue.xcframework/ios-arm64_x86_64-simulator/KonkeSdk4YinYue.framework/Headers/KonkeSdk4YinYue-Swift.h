...
#ifndef KONKESDK4YINYUE_SWIFT_H
#define KONKESDK4YINYUE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KonkeSdk4YinYue",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface H5ContentViewController (SWIFT_EXTENSION(KonkeSdk4YinYue)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC15KonkeSdk4YinYue16H5ContentWebView")
@interface H5ContentWebView : WKWebView
...
SWIFT_CLASS("_TtC15KonkeSdk4YinYue9H5Manager")
@interface H5Manager : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) H5Manager * _Nonnull shared;)
+ (H5Manager * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
